...
public class JdbcUserRepositoryImpl implements UserRepository {
    ...
    @Autowired
    public JdbcUserRepositoryImpl(@Qualifier("database") DataSource dataSource, JdbcTemplate jdbcTemplate, NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
